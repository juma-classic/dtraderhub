(function() {
    ...
    */
    ...
    var R = function(a, b, c) {
        ...
        T = function(a, b, c) {
            b && b.length > 0 && (b = ma(b), c && c.length > 0 && (b += "___" + ma(c)), b.length > 28 && (b = b.substr(0, 28) + (b.length - 28)), c = b, b = H(ka, "_p", I()), H(b, c, I())[a] = (new Date).getTime(), R(a, "_p", c))
        },
        ma = function(a) {
    ...
    U.push(["jsl", function(a) {
        ...
        if (b = a.u) a = H(M, "us", []), a.push(b), (b = /^https:(.*)$/.exec(b)) && a.push("http:" + b[1])
    }]);
    var oa = /^(\/[a-zA-Z0-9_\-]+)+$/,
        pa = [/\/amp\//, /\/amp$/, /^\/amp$/],
        qa = /^[a-zA-Z0-9\-_\.,!]+$/,
            ...
            try {
                ...
                if (e && e.length > 0) {
                    ...
                    for (d = {}; c < e.length;) {
                        ...
                        k = typeof q;
                        f = k == "object" && q !=
                            null || k == "function" ? "o" + (Object.prototype.hasOwnProperty.call(q, n) && q[n] || (q[n] = ++da)) : (typeof q).charAt(0) + q;
    ...
    var X = decodeURI("%73cript"),
        ...
        Ca = function() {
            var a = M.nonce;
            return a !== void 0 ? a && a === String(a) && a.match(Aa) ? a : M.nonce = null : F.querySelector ? (a = F.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "", a && a === String(a) && a.match(Aa) ? M.nonce = a : M.nonce = null) : null : null
        },
        Ea = function(a) {
    ...
    var Fa = function(a, b) {
        if (M.hee && M.hel > 0) try {
            ...
            b && b(c), M.hel--, Ia("debug_error", function() {
                try {
